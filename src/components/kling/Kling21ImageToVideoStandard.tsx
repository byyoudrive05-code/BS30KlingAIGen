...
interface Kling21ImageToVideoStandardProps {
  user: User;
...
export default function Kling21ImageToVideoStandard({ user, currentCredits, onGenerate, reusedPrompt, onPromptUsed, hasProcessingVideo, processingCount = 0 }: Kling21ImageToVideoStandardProps) {
  ...
  useEffect(() => {
    ...
    const checkAccess = async () => {
      const accessResult = await checkModelAccess(user, 'v2.1', 'image-to-video-standard');
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6">
      <h2 className="text-xl font-bold text-gray-800 mb-6">Kling v2.1 - Image to Video Standard</h2>
