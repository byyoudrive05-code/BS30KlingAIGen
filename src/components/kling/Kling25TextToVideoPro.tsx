...
interface Kling25TextToVideoProProps {
  user: User;
...
export default function Kling25TextToVideoPro({ user, currentCredits, onGenerate, reusedPrompt, onPromptUsed, hasProcessingVideo, processingCount = 0 }: Kling25TextToVideoProProps) {
  ...
  useEffect(() => {
    ...
    const checkAccess = async () => {
      const accessResult = await checkModelAccess(user, 'v2.5-turbo', 'text-to-video-pro');
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6">
      <h2 className="text-xl font-bold text-gray-800 mb-6">Kling v2.5 Turbo - Text to Video Pro</h2>
