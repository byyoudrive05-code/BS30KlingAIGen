...
export default function Kling25ImageToVideoStandard({ user, currentCredits, onGenerate, reusedPrompt, onPromptUsed, hasProcessingVideo }: Kling25ImageToVideoStandardProps) {
